 ...
 */
/// This files also references some ideas/solutions from https://github.com/ckddbs/three-fbx-loader
var pako = require('pako');
var THREE = require('three');
module.exports = (function () {
    CustomFBXLoader = function (manager) {

        this.manager = (manager !== undefined) ? manager : THREE.DefaultLoadingManager;

    };

    Object.assign(CustomFBXLoader.prototype, {
